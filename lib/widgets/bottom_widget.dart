    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: borderColor ?? Colors.grey.withValues(alpha: .4),
            width: .7,
          ),
            ...
            children: [
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color:
                        labelAndIconColor ?? Colors.grey.withValues(alpha: .7),
                  ),
                ),
              ),
              Icon(
                icon,
                color: labelAndIconColor ?? Colors.grey.withValues(alpha: .8),
                size: 19,
              ),
            ],
          ),
